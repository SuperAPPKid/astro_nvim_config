...

  {
    ...
    opts = function(_, opts)
      ...
      local tab_func = function(bufr)
        local tabOpen = function()
          vim.cmd "wincmd T"
          require("goto-preview").close_all_win { skip_curr_window = false }
          vim.lsp.buf.definition()
        end

        vim.keymap.set("n", "<Tab>", tabOpen, {
          noremap = true,
          silent = true,
          buffer = bufr,
        })
      ...
      local close_func = function(bufr)
        vim.keymap.set("n", "q", function() require("goto-preview").close_all_win { skep_curr_windoe = false } end, {
          noremap = true,
          silent = true,
          buffer = bufr,
        })
      ...
      opts.post_close_hook = function(bufr, _)
